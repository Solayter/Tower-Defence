    ...
    public partial class MainForm : Form
    {
        ...
        private void picBox_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    infoLabel.Text = "HP: " + chosenCell.obj.hp + "\n" + "DMG: " + chosenCell.obj.damage;
                }
                else
                {
                    infoLabel.Text = "0";
        ...
        private void loadBut_Click(object sender, EventArgs e)
        {
            ...
            {
                Memento.OpenFile(file.FileName,game);
            }
        }
        ...
        {
            //if (chosenCell.obj != null)
            //    game.Changer(ref chosenCell.obj, Convert.ToInt32(hpText.Text), Convert.ToInt32(dmgText.Text));
        }

        private void dmgText_TextChanged(object sender, EventArgs e)
        {
